    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="#"><i class="fa fa-send"></i> <span>Transactions</span></a></li>
          <li><a href="#"><i class="fa fa-money"></i> <span>Withdrawals</span></a></li>
          <li><a href="#"><i class="fa fa-plus"></i> <span>Deposits</span></a></li>
          <li><a href="#"><i class="fa fa-info-circle"></i> <span>Help Requests</span></a></li>
